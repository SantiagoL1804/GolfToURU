...
class UI {
  displayProducts(products) {
    ...
    products.forEach((product) => {
      result += `<!-- producto individual -->
      <article class="product">
        <div class="img-container">
          <img src=${product.image} alt=${product.id} class="product-img" />
    ...
    buttons.forEach((button) => {
      ...
      button.addEventListener("click", (event) => {
        ...
        const sweetA = Swal.fire({
          ...
          toast: true,
          position: "top-start",
          background: "url(./images/golf-ball.jpg)",
          showClass: {
  ...
  addCartItem(item) {
    ...
    div.innerHTML = `<img src=${item.image} alt="driver" />
    <div>
      <h4>${item.title}</h4>
